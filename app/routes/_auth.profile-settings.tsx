...
export default function Profile() {
  ...
  const handlePasswordReset = async () => {
    try {
      const response = await fetch("http://localhost/api/password/email", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        ...
        <div className="p-6 sm:p-10">
          ...
          <div className="text-right mt-4">
            <button
              ...
              className="bg-red-600 text-white px-4 py-2 font-bold rounded-lg shadow-md transition duration-150 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
            >
